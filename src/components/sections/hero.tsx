...
export function Hero() {
  ...
  return (
    <section
      className="relative flex flex-col overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-center"
      style={{ height: 'calc(100svh - 40px)', minHeight: 'calc(100svh - 40px)', maxHeight: 'calc(100svh - 40px)' }}
    >
      {/* Background */}
      ...
      <div className="relative z-10 flex flex-1 items-center justify-center px-4 pt-20 sm:px-6">
      ...
      <div
        className="relative z-10 shrink-0 pb-10 opacity-0 animate-fade-in sm:pb-12"
        style={fadeStyle5}
      >
