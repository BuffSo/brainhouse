...
export function PortfolioDetail({ slug, backgroundImage }: PortfolioDetailProps) {
  ...
  return (
    <>
            ...
            {category.items.map((item, index) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <h3 className="text-sm font-semibold text-slate-900 group-hover:text-blue-600 transition-colors sm:text-base leading-relaxed">
                    {item.title}
                  </h3>
                  <span className="shrink-0 rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-semibold text-blue-600 ring-1 ring-blue-100">
                    {item.year}
                  </span>
                </div>
              ...
              {t.portfolioMenu?.items
                ...
                .map((item) => (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-slate-100 px-4 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-blue-50 hover:text-blue-600"
                  >
                    {item.shortTitle}
      ...
      {/* Contact CTA */}
      <section className="bg-gradient-to-r from-blue-600 to-blue-700 py-10 sm:py-12">
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
              <Link
                href="/contact"
                className="inline-flex h-11 w-full items-center justify-center rounded-md bg-white px-8 text-sm font-medium text-blue-600 transition-colors hover:bg-blue-50 sm:w-auto"
              >
